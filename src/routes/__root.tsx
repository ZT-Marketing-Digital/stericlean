...
const fallback = translations.pt.meta;
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#1d2621" },
      { property: "og:site_name", content: "SteriClean" },
      ...
      { property: "og:image:height", content: "630" },
      {
        ...
        content: "SteriClean — tecnologia de água eletrolisada",
      },
